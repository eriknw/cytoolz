...
#endif
#include <math.h>
#define __PYX_HAVE__cytoolz__curried_exceptions
#define __PYX_HAVE_API__cytoolz__curried_exceptions
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
int __pyx_module_is_main_cytoolz__curried_exceptions = 0;
...
static char __pyx_k_home_erik_git_cytoolz_cytoolz_c[] = "/home/erik/git/cytoolz/cytoolz/curried_exceptions.pyx";
...
static PyMethodDef __pyx_mdef_7cytoolz_18curried_exceptions_1merge_with = {__Pyx_NAMESTR("merge_with"), (PyCFunction)__pyx_pw_7cytoolz_18curried_exceptions_1merge_with, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7cytoolz_18curried_exceptions_merge_with)};
 ...
 */
  ...
  if (__pyx_t_2) {
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_dicts, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_3 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt_Tuple(__pyx_v_dicts, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_3 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __pyx_t_3 = __pyx_f_7cytoolz_9dicttoolz_c_merge_with(__pyx_v_func, __pyx_v_dicts); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("curried_exceptions"),
    0, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcurried_exceptions(void); /*proto*/
PyMODINIT_FUNC initcurried_exceptions(void)
#else
PyMODINIT_FUNC PyInit_curried_exceptions(void); /*proto*/
PyMODINIT_FUNC PyInit_curried_exceptions(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_curried_exceptions(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("curried_exceptions"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cytoolz__curried_exceptions) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cytoolz.curried_exceptions")) {
      if (unlikely(PyDict_SetItemString(modules, "cytoolz.curried_exceptions", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init cytoolz.curried_exceptions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cytoolz.curried_exceptions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
